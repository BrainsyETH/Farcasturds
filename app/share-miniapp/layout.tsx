...
export async function generateMetadata({
  ...
  const image = typeof searchParams.image === 'string' ? searchParams.image : null;
  ...
  // Use preview for OG image, fallback to image param or default
  const ogImage = preview || image || `${process.env.NEXT_PUBLIC_APP_URL}/splash.png`;
...
export default function ShareMiniAppLayout({
  children,
}: {
